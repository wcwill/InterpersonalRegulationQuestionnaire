### 1 - IRQ_preval_TP convert JSON script: convert JSON results into long-form R dataframe
setwd("")
...
# import data
d <- read.delim("IRQ_preval_TP.tsv", stringsAsFactors = FALSE)
...
# write to CSV file
write.csv(d_choice, "IRQ_preval_TP_choiceSection_raw.csv", row.names = FALSE)
...
# write to CSV file
write.csv(d_taskSection, "IRQ_preval_TP_taskSection_raw.csv", row.names = FALSE)
