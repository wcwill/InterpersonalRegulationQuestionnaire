...
d_choiceSection <- read.csv('IRQ_preval_TN_choiceSection_raw.csv')
d_taskSection <- read.csv('IRQ_preval_TN_taskSection_raw.csv')
...
# write to CSV file
write.csv(d_choice, "IRQ_preval_TN_choice_proc.csv", row.names = FALSE)